...
const POLLING_INTERVAL = 3000; // 轮询间隔
const ANIMATION_DURATION = 6000; // 动画持续时间(毫秒)
...
// 添加新的全局变量
const INTERPOLATION_STEPS = 60; // 每两帧之间的插值步数
...
onMounted(async () => {
    ...
    document.getElementById('satButton').addEventListener('click', () => {
        ...
        // // 添加 Bing Maps Aerial 地图
        // const imageryProvider = new Cesium.BingMapsImageryProvider({
        //     url: 'https://dev.virtualearth.net',
        //     mapStyle: Cesium.BingMapsStyle.AERIAL // 使用 Aerial 样式
        // });
